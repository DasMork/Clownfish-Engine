Public NotInheritable Class SplashScreen1
    ...
    Private Sub SplashScreen1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If My.Application.Info.Title <> "" Then
            Editor.Text = My.Application.Info.Title
        Else
            'Wenn der Anwendungstitel fehlt, Anwendungsnamen ohne Erweiterung verwenden
            Editor.Text = System.IO.Path.GetFileNameWithoutExtension(My.Application.Info.AssemblyName)
        End If
    ...
    Private Sub ApplicationTitle_Click(sender As Object, e As EventArgs) Handles Editor.Click
